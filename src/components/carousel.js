  ...
  return (
    <div className="relative h-[500px] w-[80%] bg-[#fafafa] border p-10 rounded-xl shadow-[14px 14px 28px #d5d5d5,
     ...
     {/* arrow left */}
      ...
      >
        <ArrowLeftCircleIcon  className="h-5 w-5 text-orange-500"/>
      </button>

     {/* quotes */}
      <div className="flex relative flex-col items-center justify-center w-full h-full p-10">
        <h1 className="text-4xl absolute left-8 top-32 italic">"</h1>
        <blockquote className="text-center text-gray-400 text-sm sm:text-2xl italic font-bold">
          {quotes[index].quote}
        </blockquote>
        <h1 className="text-4xl absolute right-8 bottom-32 m-2 italic">"</h1>
        <cite className="block absolute bottom-16 text-center text-sm font-bold">
          — {quotes[index].author}
        </cite>
      </div>
